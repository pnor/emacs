      ...
      if (!face->stipple) {
        if (s->hl != DRAW_CURSOR) {
          if (NS_FACE_BACKGROUND(face) != 0) {
            ...
            [[index_color colorWithAlphaComponent:s->f->alpha_background] set];
          } else {
            NSColor *frame_bg_color = FRAME_BACKGROUND_COLOR(s->f);
            [[frame_bg_color colorWithAlphaComponent:s->f->alpha_background]
                set];
          }
        } else {
        ...
        NSColor *stipple_mask_color =
            [dpyinfo->bitmaps[face->stipple - 1].img stippleMask];
        [[stipple_mask_color colorWithAlphaComponent:s->f->alpha_background]
            set];
      }
   ...
   -------------------------------------------------------------------------- */
{
  ...
  switch (s->first_glyph->type)
    ...
    case IMAGE_GLYPH: // TODO does this fix image transp?
